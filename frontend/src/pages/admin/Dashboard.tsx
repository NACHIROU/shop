...
export default function AdminDashboard() {
  ...
  const uniqueProducts = new Set(safeProducts.map(p => p?.name || 'Inconnu')).size;
          ...
          <>
            ...
            <div className="bg-card p-6 rounded-xl border border-border shadow-sm animate-fade-in">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 rounded-lg bg-muted/50">
                  <p className="text-2xl font-bold text-warning">{isPrivate ? "••••••" : formatCurrency(monthlyStats?.totalValue || 0)}</p>
                ...
                <div className="text-center p-4 rounded-lg bg-muted/50">
                  <p className={cn("text-2xl font-bold", (monthlyStats?.globalBalance || 0) >= 0 ? "text-blue-500" : "text-destructive")}>
                    {isPrivate ? "••••••" : formatCurrency(monthlyStats?.globalBalance || 0)}
                  </p>
